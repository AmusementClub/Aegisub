...
TEST(lagi_syntax, drawing_number_formats) {
	tok_str("{\\p1}m +1.5 -2E-3 l 3e+4 5.0{\\p0}x", false,
		expect_style(ss::OVERRIDE, 1u);
		expect_style(ss::PUNCTUATION, 1u);
		expect_style(ss::TAG, 1u);
		expect_style(ss::PARAMETER, 1u);
		...
		expect_style(ss::DRAWING_CMD, 1u);
		expect_style(ss::NORMAL, 1u);
		expect_style(ss::DRAWING_X, 4u);
		expect_style(ss::NORMAL, 1u);
		expect_style(ss::DRAWING_Y, 5u);
		expect_style(ss::NORMAL, 1u);
		expect_style(ss::DRAWING_CMD, 1u);
		expect_style(ss::NORMAL, 1u);
		expect_style(ss::DRAWING_X, 4u);
...
TEST(lagi_syntax, drawing_without_root_command) {
...
TEST(lagi_syntax, empty_clip_is_not_drawing) {
	tok_str("{\\clip()}", false,
		expect_style(ss::OVERRIDE, 1u);
		expect_style(ss::PUNCTUATION, 1u);
		expect_style(ss::TAG, 4u);
...
TEST(lagi_syntax, unknown_clip_suffix_is_not_drawing) {
	tok_str("{\\xclip(m 0 0 l 1 1)}", false,
		expect_style(ss::OVERRIDE, 1u);
		expect_style(ss::PUNCTUATION, 1u);
		expect_style(ss::TAG, 5u);
		expect_style(ss::PUNCTUATION, 1u);
		expect_style(ss::PARAMETER, 11u);
		expect_style(ss::PUNCTUATION, 1u);
		expect_style(ss::OVERRIDE, 1u);
	);
}
